...
Video Analytics | Analytics | Video Analytics is the process of collecting and aggregating video metrics. | No
...
The following methods are used to track state and actions ([event creation and tracking](#event-tracking)):
...
The following methods are used to track commerce events ([product creation and tracking](#ecommerce)):
