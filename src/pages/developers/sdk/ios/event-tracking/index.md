...
If you have a high-volume event that you would like to forward to kits but exclude from uploading to mParticle, set the Boolean flag `event.shouldUploadEvent` per event.
