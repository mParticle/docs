...
* **Compliance** - Can view and manage the [Requests Page](/guides/data-subject-requests/forwarding/#managing-data-subject-requests-in-the-mparticle-dashboard). Has Read Only access in other parts of the dashboard
* **Admin & Compliance** - All Admin permissions, plus can view and manage the [Requests Page](/guides/data-subject-requests/forwarding/#managing-data-subject-requests-in-the-mparticle-dashboard)
