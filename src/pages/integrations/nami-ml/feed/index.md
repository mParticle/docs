...
3. Also in the Nami ML Control Center, map the appropriate Nami ML identity type to mParticle's Customer ID identifier. Nami ML will also send namiml_user_id as a Partner Identity.
